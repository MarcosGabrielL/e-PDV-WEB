 ...
 * @author Marcos
 */
public class GeraChaveAcessoNFE {
   ...
   private static NotaNFCeService notaNFCeService;
    ...
    public String getnfe(NotaNFE nota){
    ...
    public static void getNumeroeSerie(NotaNFE nota){
    
        try{
        String SérieAtual = null;
       // NotaNfeDAO notadao = new NotaNfeDAO();
        //CaixaDAO cdao = new CaixaDAO();
        //for(Caixa c: cdao.readdesc(nota.getLoja(), Integer.parseInt(nota.getCaixa()))){
          //  SérieAtual = c.getSerieNFE();
        //}
        //int SérieAtual = notadao.Serie(nota.getLoja(), nota.getCaixa());
        
         int Maiornumero = 1;
       // try{
         //   Maiornumero = notadao.Numero(nota.getLoja(), nota.getCaixa(), SérieAtual);
        //}catch(Exception e){
        ...
        System.err.println();
            ...
            System.out.println("Erro Ler notas: "+e);
            Logger.getLogger(GeraChaveAcessoNFE.class.getName()).log(Level.SEVERE, null, e);
        }
